...
avatar_user6 = URI.open("https://res.cloudinary.com/dusgqtd1w/image/upload/v1593809733/lety.jpg")
...
avatar_user7 = URI.open("https://res.cloudinary.com/dusgqtd1w/image/upload/v1593809734/violaa.jpg")
...
avatar_user9 = URI.open("https://res.cloudinary.com/dusgqtd1w/image/upload/v1593809734/juliana.jpg")
user9 = User.create!(username: "Juliana", email: "juliana@decide.com", password: "123456")
user9.avatar.attach(io: avatar_user9, filename: "juliana.jpg", content_type: "image/jpg")
...
dilemma_7_option_2 = Option.create!(description: "Lasagna",
                                    dilemma_id: dilemma_7.id)
dilemma_7.expired_at = dilemma_7.expired_at - 2.day
dilemma_7.save!
puts "Dilemma created"
...
dilemma_13_option_2 = Option.create!(description: "no",
                                    dilemma_id: dilemma_13.id)
dilemma_13.expired_at = dilemma_13.expired_at - 1.week
dilemma_13.save!
puts "Dilemma created"
